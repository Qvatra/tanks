...
var Tank = function Tank(name, _ref, angle) {
	...
	var _angle = angle;
	var _speed = 1;
	var _tankCoords = { x: x, y: y };

	this.updateRadar = function (enemyCoords) {
...
var applyTanksAi = function applyTanksAi() {
	_lodash2.default.forEach(battleField.getTanks(), function (tank, idx) {
		if (idx === 0) {
			tank.setAngle(30);
		} else {
