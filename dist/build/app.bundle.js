...
/******/return __webpack_require__(__webpack_require__.s=9);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(global,module){var __WEBPACK_AMD_DEFINE_RESULT__;var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};/**
 * @license
...
root._=_;}}).call(undefined);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(7),__webpack_require__(8)(module));/***/},/* 1 *//***/function(module,exports){/* WEBPACK VAR INJECTION */(function(__webpack_amd_options__){/* globals __webpack_amd_options__ */module.exports=__webpack_amd_options__;/* WEBPACK VAR INJECTION */}).call(exports,{});/***/},/* 2 *//***/function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(0);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var BattleField=function BattleField(){_classCallCheck(this,BattleField);var _tanks=[];this.addTank=function(tank,coords){var extendedTank=_lodash2.default.extend(tank,{coords:coords});console.log('Tank',extendedTank.getName(),'has been added to',extendedTank.coords);_tanks.push(extendedTank);};this.removeTank=function(tank){_lodash2.default.remove(_tanks,function(t){return t===tank;});};this.getTanks=function(){return _tanks;};this.moreThanOneTank=function(){return _tanks.length>1;};};exports.default=BattleField;/***/},/* 3 *//***/function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _lodash=__webpack_require__(0);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var Tank=function Tank(name){_classCallCheck(this,Tank);var _name=name;var _enemiesCoords=[];this.setRadar=function(enemiesCoords){console.log('Tank',_name,'sees enemies at',JSON.stringify(enemiesCoords));_enemiesCoords=enemiesCoords;};this.shoot=function(){console.log('Tank',_name,'fires');};this.move=function(){console.log('Tank',_name,'moves');return{x:1,y:-1};};this.rotate=function(){console.log('Tank',_name,'rotates');return{x:1,y:1};};this.getName=function(){return _name;};};exports.default=Tank;/***/},/* 4 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(10);if(typeof content==='string')content=[[module.i,content,'']];// Prepare cssTransformation
var transform;var options={};options.transform=transform;// add the styles to the DOM
var update=__webpack_require__(11)(content,options);if(content.locals)module.exports=content.locals;// Hot Module Replacement
if(false){// When the styles change, update the <style> tags
if(!content.locals){module.hot.accept("!!../node_modules/css-loader/index.js??ref--1-1!../node_modules/sass-loader/lib/loader.js??ref--1-2!./index.scss",function(){var newContent=require("!!../node_modules/css-loader/index.js??ref--1-1!../node_modules/sass-loader/lib/loader.js??ref--1-2!./index.scss");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
module.hot.dispose(function(){update();});}/***/},/* 5 *//***/function(module,exports,__webpack_require__){"use strict";/*
...
var base64=btoa(unescape(encodeURIComponent(JSON.stringify(sourceMap))));var data='sourceMappingURL=data:application/json;charset=utf-8;base64,'+base64;return'/*# '+data+' */';}/***/},/* 6 *//***/function(module,exports,__webpack_require__){"use strict";/**
...
return fixedCss;};/***/},/* 7 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};var g;// This works in non-strict mode
...
module.exports=g;/***/},/* 8 *//***/function(module,exports,__webpack_require__){"use strict";module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
if(!module.children)module.children=[];Object.defineProperty(module,"loaded",{enumerable:true,get:function get(){return module.l;}});Object.defineProperty(module,"id",{enumerable:true,get:function get(){return module.i;}});module.webpackPolyfill=1;}return module;};/***/},/* 9 *//***/function(module,exports,__webpack_require__){"use strict";__webpack_require__(4);var _BattleField=__webpack_require__(2);var _BattleField2=_interopRequireDefault(_BattleField);var _Tank=__webpack_require__(3);var _Tank2=_interopRequireDefault(_Tank);var _lodash=__webpack_require__(0);var _lodash2=_interopRequireDefault(_lodash);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}var battleField=new _BattleField2.default();battleField.addTank(new _Tank2.default('A'),{x:0,y:0});battleField.addTank(new _Tank2.default('B'),{x:50,y:50});var removeAllDeadTanks=function removeAllDeadTanks(){console.log('cleaning the battlefield');};var updateRadars=function updateRadars(){var allTanks=battleField.getTanks();_lodash2.default.forEach(allTanks,function(tank){var enemyTanks=_lodash2.default.filter(allTanks,function(t){return t.getName()!==tank.getName();});var enemyCoords=_lodash2.default.map(enemyTanks,function(t){return t.coords;});tank.setRadar(enemyCoords);});};var rotateAll=function rotateAll(){_lodash2.default.forEach(battleField.getTanks(),function(tank){tank.rotate();});};var shootAll=function shootAll(){_lodash2.default.forEach(battleField.getTanks(),function(tank){tank.shoot();});removeAllDeadTanks();};var moveAll=function moveAll(){_lodash2.default.forEach(battleField.getTanks(),function(tank){var movement=tank.move();tank.coords.x+=movement.x;tank.coords.y+=movement.y;});};var i=0;while(battleField.moreThanOneTank()){updateRadars();rotateAll();shootAll();moveAll();if(i++===3){battleField.removeTank(battleField.getTanks()[1]);}}document.getElementById('test').innerHTML='Tank '+_lodash2.default.first(battleField.getTanks()).getName()+' won the game!';/***/},/* 10 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(5)(true);// imports
// module
exports.push([module.i,"body {\n  background-color: #09c476; }\n\nh1 {\n  margin-left: 50px;\n  color: #FFF;\n  font-family: 'Avenir Next', sans-serif;\n  font-size: 100px;\n  font-weight: 400; }\n","",{"version":3,"sources":["C:/projects/tanks/src/src/index.scss"],"names":[],"mappings":"AAGA;EACE,0BAHe,EAIhB;;AAED;EAEI,kBAAU;EAEZ,YAXU;EAYV,uCAAsC;EACtC,iBAAgB;EAChB,iBAAgB,EACjB","file":"index.scss","sourcesContent":["$white: #FFF;\n$success: #09c476;\n\nbody {\n  background-color: $success;\n}\n\nh1 {\n  margin: {\n    left: 50px;\n  }\n  color: $white;\n  font-family: 'Avenir Next', sans-serif;\n  font-size: 100px;\n  font-weight: 400;\n}\n"],"sourceRoot":""}]);// exports
...
css+="\n/*# sourceMappingURL=data:application/json;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(sourceMap))))+" */";}var blob=new Blob([css],{type:"text/css"});var oldSrc=linkElement.href;linkElement.href=URL.createObjectURL(blob);if(oldSrc)URL.revokeObjectURL(oldSrc);}/***/}]/******/);//# sourceMappingURL=app.bundle.js.map
